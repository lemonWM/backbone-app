module.exports = function(grunt){
    ...
    grunt.initConfig({
        ...
        jst: {
            ...
            }, // kompilowanie templatek jst 
            dist: {
                src:'dist/public/templates/*.html',
            ...
            dist: {
                files: {
                    ...
                    "dist/public/js/app.min.js": [
                        "dist/public/templates/templates.js",
                        "public/js/Setup.js",
                        "public/js/models/*.js",
    ...
    grunt.registerTask('build', ["clean", "targethtml", "copy","concat", "jst", "uglify", "cssmin", "htmlmin", ]);
